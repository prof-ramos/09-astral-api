...
from ..security.api_key_security import validate_api_key
...
# Router sem autenticação para endpoints públicos
public_router = APIRouter()

# Router com autenticação para endpoints protegidos
...
@public_router.get("/api/v4/health", response_description="Health check", include_in_schema=False)
...
@public_router.get("/", response_description="Status of the API", response_model=BirthDataResponseModel, include_in_schema=False)
...
@protected_router.get("/api/v4/now", response_description="Current astrological data", response_model=BirthDataResponseModel)
...
@protected_router.post("/api/v4/birth-data", response_description="Birth data", response_model=BirthDataResponseModel)
...
@protected_router.post("/api/v4/birth-chart", response_description="Birth chart", response_model=BirthChartResponseModel)
...
@protected_router.post("/api/v4/synastry-chart", response_description="Synastry data", response_model=SynastryChartResponseModel)
...
@protected_router.post("/api/v4/transit-chart", response_description="Transit data", response_model=TransitChartResponseModel)
...
@protected_router.post("/api/v4/transit-aspects-data", response_description="Transit aspects data", response_model=TransitAspectsResponseModel)
...
@protected_router.post("/api/v4/synastry-aspects-data", response_description="Synastry aspects data", response_model=SynastryAspectsResponseModel)
...
@protected_router.post("/api/v4/natal-aspects-data", response_description="Birth aspects data", response_model=SynastryAspectsResponseModel)
...
@protected_router.post("/api/v4/relationship-score", response_description="Relationship score", response_model=RelationshipScoreResponseModel)
...
@protected_router.post("/api/v4/composite-chart", response_description="Composite data", response_model=CompositeChartResponseModel)
...
@protected_router.post("/api/v4/composite-aspects-data", response_description="Composite aspects data", response_model=CompositeAspectsResponseModel)
